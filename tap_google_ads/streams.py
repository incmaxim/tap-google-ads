...
def initialize_core_streams(resource_schema):
    return {
        ...
        # "feed": BaseStream(  # REMOVED - deprecated in Google Ads API v19+
        ...
        # ),
        # "feed_item": BaseStream(  # REMOVED - deprecated in Google Ads API v19+
...
def initialize_reports(resource_schema):
    return {
        ...
        # "placeholder_feed_item_report": ReportStream(  # REMOVED - deprecated in Google Ads API v19+
        ...
        #      }
        # ),
        # "placeholder_report": ReportStream(  # REMOVED - deprecated in Google Ads API v19+
